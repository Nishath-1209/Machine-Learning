...
st.markdown("""
            ...
            <p>Predict <b> Tip Amount </b> from <b> Total Billl </b> using Multiple Linear Regression...</p>
            </div>
...
st.dataframe(df[["total_bill","tip"]].head(10))
